    ...
    <Layout>
      <div id="snaps" className="w-screen h-screen overflow-auto ">
          ...
          <div className="grid w-full px-2 py-5 rounded-lg bg-primary place-content-center md:w-2/3 md:py-10 md:px-10 ">
            <div className="flex flex-col items-center justify-center md:flex-row gap-x-5 gap-y-5">
              <div className="flex flex-col gap-y-4 ">
                <h2 className="text-xl font-bold md:text-2xl lg:text-4xl text-slate-800 ">
                  Hi there! <br /> I'm Rainisa Sofhia
                </h2>
                <div className="text-sm font-semibold md:text-xl lg:text-2xl text-slate-800">
                  <Typewriter
                    options={{
                      strings: [
        ...
        <div
          ...
          className="flex items-center justify-center min-h-screen "
        >
          <div className="flex flex-col items-center justify-center w-full px-2 py-5 my-32 rounded-lg bg-primary md:flex-row md:w-2/3 h-2/3 md:my-4 lg:my-0 md:py-10 md:px-5 ">
            <h1 className="text-base italic font-thin text-justify md:text-lg lg:text-lg text-slate-800 ">
        ...
        <div
          ...
          className="flex items-center justify-center min-h-screen "
        >
          <div className="grid w-full grid-cols-2 gap-2 px-2 py-5 my-20 align-middle rounded-lg bg-primary place-items-center md:grid-cols-4 md:gap-4 place-content-center md:w-2/3 md:py-10 md:px-10 ">
            <img
        ...
        <div
          ...
          className="flex items-center justify-center min-h-screen "
        >
          <div className="flex w-full gap-2 px-2 py-5 my-20 overflow-auto bg-primary md:gap-4 md:w-2/3 md:py-10 md:px-10">
